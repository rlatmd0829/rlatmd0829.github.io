...
@Lock을 사용하여 PESSIMISTIC_WRITE 락을 설정한 경우, 해당 레코드에 대한 수정 작업을 시도하는 트랜잭션은 해당 레코드에 대한 락을 획득합니다. 이 락은 해당 트랜잭션이 끝날 때까지 해당 레코드에 대한 다른 쓰기 작업을 막습니다.
